...
def main() -> int:
    ...
    (soulgold / "PMD_G3R6A_INSTALL_STATUS.txt").write_text(
        ...
        "ambient_known_defect=CYNDAQUIL_SINGLE_1PX_SINK_DEFERRED_BY_USER\n"
        "new_action=HURT\n"
        "hurt_source=PMDCOLLAB_HURT_ANIM_OFFSETS_SHADOW\n"
        "hurt_trigger=CONTROLLER_HITANIMATION\n"
        "hurt_body_correction=ZERO_SOURCE_AUTHORITATIVE\n"
        "hurt_shadow=FRAME_SYNCHRONOUS_AUTHENTIC_PMDCOLLAB\n"
