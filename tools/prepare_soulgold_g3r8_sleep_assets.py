...
def main()->int:
    ...
    summary={
        ...
        "sleep_shadow_policy":"FRAME_SYNCHRONOUS_AUTHENTIC_PMDCOLLAB_SLEEP_SHADOW",
    ...
    try:
        for target in TARGETS:
            ...
            combined.setdefault("shadow",{})["shadow_size"]=shadow_size; combined["shadow"]["g3r8_policy"]="FRAME_SYNCHRONOUS_PMDCOLLAB_WITH_SLEEP"
            ...
            summary["targets"][key]={
                "species":target["species"],"variant":target["variant"],"direction":target["direction"],"battle_anchor":anchor,
    ...
    for k,r in summary["targets"].items(): print(k,"Sleep",r["sleep_source_frame_size"],r["sleep_durations"],"atlas",r["expanded_shadow_atlas_frame_count"])
