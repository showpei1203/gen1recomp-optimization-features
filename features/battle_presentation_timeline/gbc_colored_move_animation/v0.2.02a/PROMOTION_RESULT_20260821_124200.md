...
v0.2.02a is derived from v0.2.01f and removes only TEST-only A2 fixture / B-hook plumbing. GBC visuals, Psybeam `beam_release` semantics and sealed battle authorities are frozen from the accepted test state.
